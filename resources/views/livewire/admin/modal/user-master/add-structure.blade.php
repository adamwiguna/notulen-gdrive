<div wire:ignore.self  class="modal fade" id="addStructureUserMasterModal" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            <div wire:loading wire:target="getUserMaster">
            ...
            <div  wire:loading.remove wire:target="getUserMaster" class="modal-header">
                <h5 class="modal-title" id="exampleModalLabel">Setting Struktur dan Jabatan untuk user {{ $userName }}</h5>
                <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
            </div>
            <div  wire:loading.remove wire:target="getUserMaster" class="modal-body">
                {{ $userSlug }}
                ...
                <div class="form-floating mb-3">
                    <select wire:model="organizationId" wire:change="resetDivsionAndPosition"  class="form-select " id="" aria-label="Floating label select example">
           ...
           --}}
                ...
                <button wire:click="updateUserMaster({{ $userId }})" type="submit" class="btn btn-primary mt-3" data-bs-dismiss="modal" >
