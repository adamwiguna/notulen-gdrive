<div wire:ignore.self  class="modal fade" id="createPositionMasterModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            ...
            <div  wire:loading.remove wire:target="createPositionMaster, getPositionMaster" class="modal-body">
                ...
                <button wire:click="storePositionMaster" type="submit" class="btn btn-primary mt-3" data-bs-dismiss="modal" >
